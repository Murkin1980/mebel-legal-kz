...
- безопасный ZIP-импорт бухгалтерского архива с `manifest.csv`, предпросмотром,
  tenant isolation, SHA-256 idempotency и закрытым Storage;
- админка создания компаний и одноразовых приглашений по ролям;
